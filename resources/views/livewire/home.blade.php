...
-->
    ...
    <section class="container py-5">
        ...
        <div class="bgvid">
        <video autoplay="true" muted="true" loop="true" width="720" height="auto" controls>
          <source src="{{ url('assets/vid/videoplaybacks.mp4') }}" type="video/mp4" />
        </video>
      </div>
